<template>
    <div class="flex justify-center items-center min-h-screen bg-violet-300">
      <div class="container mx-auto p-8 bg-gray-500 rounded-lg shadow-lg border border-black-300 bg-blue">
